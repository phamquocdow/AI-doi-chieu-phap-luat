...
```powershell
ssh -p <PORT-MỚI> root@<IP-MỚI> -i "C:\Users\Hung\.ssh\id_ed25519" -o StrictHostKeyChecking=no
```
...
```powershell
ssh -N -L 127.0.0.1:8000:127.0.0.1:8000 -p <PORT-MỚI> root@<IP-MỚI> -i "C:\Users\Hung\.ssh\id_ed25519" -o StrictHostKeyChecking=no -o ServerAliveInterval=15 -o ServerAliveCountMax=3
```
